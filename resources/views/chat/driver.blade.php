...
@push('styles')
    ...
    @vite(['resources/css/chat-driver.css'])
@endpush
...
<div id="image-lightbox">
    <button id="lightbox-close" style="position:absolute;top:20px;right:30px;color:#fff;font-size:30px;background:none;border:none;cursor:pointer">&times;</button>
...
@push('scripts')
    @vite(['resources/js/chat-driver.js'])
@endpush