        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h4><i class="bi bi-person-circle"></i> Profile Driver</h4>
                </div>
                <div class="card-body">
                    @if(session('success'))
...
@endif
                        ...
                        @if($user->avatar)
                            <div class="mt-3">
                                <form method="POST" action="{{ route('driver.profile.delete-photo') }}" 
                    ...
                    <form method="POST" action="{{ route('driver.profile.change-password') }}">
                        @csrf
                        <div class="form-group">
