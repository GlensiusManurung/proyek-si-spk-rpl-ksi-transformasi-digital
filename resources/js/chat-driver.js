...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Chat Driver loaded, Auth ID:', window.ChatConfig?.authId);
...
function initContactHandlers() {
    document.querySelectorAll('.chat-user').forEach(contact => {
        contact.addEventListener('click', function(e) {
            ...
            const userAvatar = this.dataset.userAvatar; // ← PASTIKAN ADA
            ...
            document.getElementById('chat-header').innerHTML = `
                <div class="chat-header-info">
                    ...
                    <div>
                        <h5 class="hdr-name">${escapeHtml(userName)}</h5>
...
function initSearch() {
    // Perbaikan: coba kedua kemungkinan ID
    const searchInput = document.getElementById('contact-search') || document.getElementById('search-contact');
    
    if (searchInput) {
        console.log('Search input found in chat-driver.js');
        ...
        console.log('Search input not found in chat-driver.js! Available IDs: contact-search, search-contact');
    }
}
